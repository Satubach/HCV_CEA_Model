...
MSHCV_20 <- MS_results_20 %>% 
  pivot_wider(
    ...
    values_from = c(prevalence, prevalence_rate, incidence)
  )

All_HCV_Sum <- "C:\\Users\\stubach\\OneDrive - State of Kansas, OITS\\Documents\\Dissertation\\DATA\\New Analysis\\Final Analysis\\HCV_Interventions_C.csv"
...
reference_DALY <- reference_summary_20$reference_DALY
reference_cost <- reference_summary_20$reference_cost
...
HCV_cost_sum <- "C:\\Users\\stubach\\OneDrive - State of Kansas, OITS\\Documents\\Dissertation\\DATA\\New Analysis\\Final Analysis\\HCV_cost_summary.csv"
